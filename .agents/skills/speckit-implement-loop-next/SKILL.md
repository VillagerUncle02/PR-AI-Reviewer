---
name: speckit-implement-loop-next
description: Create the next chained feature branch after the current PR passes AI
  review
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: implement-loop:commands/next.md
---
...
1. 运行 `.specify/extensions/implement-loop/scripts/powershell/load-config.ps1 -Json` 解析配置，取得 `FEATURE_DIR`、`BRANCH_PREFIX`、`BRANCH_BASE`、`CHAINED`、`PREPARE_BRANCH_SCRIPT` 等；
